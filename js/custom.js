...
function background() {
    ...
    if ($(window).width() > 480) {
        ...
        $('.main').find(".press").backstretch("images/photos/press.jpg");
        ...
        $('.main').find(".photo6").backstretch("images/photos/7.jpg");
		$('.main').find(".photo7").backstretch("images/photos/16.jpg");
		$('.main').find(".photo8").backstretch("images/photos/4.jpg");
    }
}
